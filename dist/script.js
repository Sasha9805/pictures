...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_mask__WEBPACK_IMPORTED_MODULE_4__["default"])('input[name="phone"]');
  Object(_modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_5__["default"])('input[name="name"], [name="message"]');
  ...
  Object(_modules_filter__WEBPACK_IMPORTED_MODULE_8__["default"])('.portfolio-menu', '.portfolio-wrapper', '.portfolio-no', '.all', 'active');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var burger = function burger(menuSelector, triggerSelector) {
...
var calc = function calc(size, material, options, promocode, result) {
  ...
  promocodeBlock.addEventListener('input', calcFunc); // Запрос на сервер при получении данных для value элементов option
...
var drop = function drop() {
  ...
  ['dragenter'].forEach(function (eventName) {
    fileInputs.forEach(function (input) {
...
var filter = function filter(listSelector, wrapperSelector, noSelector, allSelector, activeClass) {
  var menu = document.querySelector(listSelector),
      items = menu.querySelectorAll('li'),
      wrapper = document.querySelector(wrapperSelector),
      markAll = wrapper.querySelectorAll(allSelector),
      no = document.querySelector(noSelector); // const menu = document.querySelector('.portfolio-menu'),
  //       items = menu.querySelectorAll('li'),
  ...
  menu.addEventListener('click', function (event) {
    ...
    if (target && target.tagName == 'LI') {
      ...
      var liClass = Array.from(target.classList).find(function (className) {
      ...
      var blockImg = wrapper.querySelectorAll(".".concat(liClass));
...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (event) {
      event.preventDefault();
      var phone = item.querySelector('[name="phone"]');
      ...
      if (item.classList.contains('calc-form')) {
        var price = sumBlock.textContent;
      ...
      var api = item.closest('.popup-design') || item.classList.contains('calc-form') || item.dataset.form !== undefined ? path.designer : path.question;
      console.log(api);
...
var mask = function mask(selector) {
  var setCursorPosition = function setCursorPosition(pos, elem) {
    elem.focus();
    elem.selectionStart = elem.selectionEnd = pos; // if (elem.setSelectionRange) {
...
var scrolling = function scrolling(upSelector) {
  ...
  window.addEventListener('scroll', function () {
    if (document.documentElement.scrollTop > 1650) {
      ...
      upElem.classList.add('animated', 'fadeIn'); // upElem.style.display = 'block';
    } else {
      upElem.classList.remove('fadeIn');
      upElem.classList.add('fadeOut'); // upElem.style.display = 'none';
    }
  }); // raf scrolling
  ...
  links.forEach(function (link) {
    link.addEventListener('click', function (event) {
      ...
      var widthTop = Math.round(html.scrollTop || body.scrollTop),
          hash = this.hash,
...
var showMoreStyles = function showMoreStyles(trigger, styles) {
  var cards = document.querySelector(styles),
